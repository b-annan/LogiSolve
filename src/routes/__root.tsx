...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ILVAR — Intelligent Logic Verification & Automated Reasoning" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "ILVAR — Intelligent Logic Verification & Automated Reasoning" },
      {
        ...
        content:
          "Truth tables, equivalence, CNF, resolution, SAT, predicate translation and proofs — computed locally in the browser.",
      },
